(() => {
    ...
    function initLanguageSelector() {
        if (document.querySelector(".language-selector")) {
            ...
            wrapper.querySelector(".language-selector__title");
            wrapper.querySelector(".language-selector__body");
            const activeClass = "opened";
            document.addEventListener("click", (e => {
                if (wrapper.classList.contains(activeClass) && !e.target.closest(".language-selector__body")) wrapper.classList.remove(activeClass); else if (e.target.closest(".language-selector__title") && !wrapper.classList.contains(activeClass)) wrapper.classList.add(activeClass);
            }));
        }
    }
